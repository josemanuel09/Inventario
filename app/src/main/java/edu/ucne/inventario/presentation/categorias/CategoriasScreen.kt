...
@Composable
fun CategoriasScreen(viewModel: CategoriasViewModel = hiltViewModel(), goBack: () -> Unit) {
    val uiState by viewModel.uiState.collectAsStateWithLifecycle()
    CategoriasBodyScreen(
        uiState = uiState,
    ...
    Scaffold(
        ...
        Column(
            ...
            OutlinedTextField(
                ...
                isError = uiState.descripcionErrors != null
            )
            uiState.descripcionErrors?.let { error ->
                Text(
                    text = error,
                    color = Color.Red,
                    style = TextStyle(fontSize = 12.sp)
