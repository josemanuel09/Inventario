...
fun EditProductosScreen(
    ...
    EditProductosBodyScreen(
        ...
        onProovedorChange = viewModel::onProveedorChange,
        ...
        Column(
            ...
            OutlinedTextField(
                ...
                onValueChange = { newValue ->
                    val newValue = newValue.toIntOrNull() ?: 0 // Cambié a Int
            ...
            DropdownMenu(
                ...
                proveedores.forEach { proveedor ->
                    DropdownMenuItem(
                        ...
                        onClick = {
                            onProovedorChange(proveedor.proovedorId ?: 0)
